...
<div class="min-h-screen bg-gray-100 flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-8">
        ...
        <form method="POST"
            action="{{ route('plant-types.update', $plantType) }}"
            class="space-y-5">
            ...
            <div>
                ...
                <input type="number"
                    ...
                    class="w-full rounded-xl border-gray-300 shadow-sm"
                    value="{{ $plantType->estimated_harvest_days }}">
            </div>
            ...
            <div>
                ...
                <textarea name="description"
                    rows="4"
                    class="w-full rounded-xl border-gray-300 shadow-sm">{{ $plantType->description }}</textarea>
            </div>
